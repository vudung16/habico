...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>PhotoGroups Edit</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">PhotoGroups Edit</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                    ...
                    <form id="add-photos" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{$photogroups->name}}" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="inputStatus">Content</label><br>
                                <textarea class="form-control ckeditor" id="editor1"
                                    name="content">{{$photogroups->content}}</textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
...
$(document).ready(function() {
    $('#add-photos').on('submit', function(event) {
        ...
        $.ajax({
            url: "{{url('admin/photogroups/edit')}}" + "/{{$photogroups->id}}",
            method: 'POST',
            data: data,
            dataType: 'JSON',
            contentType: false,
