            ...
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <form id="edit-role" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <a href="{{url('admin/role/list')}}" class="btn btn-secondary">Cancel</a>
...
$(document).ready(function() {
    $('#edit-role').on('submit', function(event) {
        ...
        var data = new FormData($('#edit-role')[0]);
        $.ajax({
            url: "{{url('admin/role/edit')}}" + "/{{$role->id}}",
            method: 'POST',
            data: data,
            dataType: 'JSON',
            contentType: false,
