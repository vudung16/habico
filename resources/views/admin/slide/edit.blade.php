            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Slides Edit</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <form id="edit-slides" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <img width="100px" src="{{asset('upload/slide')}}/{{$slides->image}}" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
...
$(document).ready(function() {
    $('#edit-slides').on('submit', function(event) {
        ...
        var data = new FormData($('#edit-slides')[0]);
        $.ajax({
            url: "{{url('admin/slides/edit')}}" + "/{{$slides->id}}",
            method: 'POST',
            data: data,
            dataType: 'JSON',
            contentType: false,
